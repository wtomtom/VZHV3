...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("35.196.98.145", "35.196.98.145"));
	    vSeeds.push_back(CDNSSeedData("35.231.114.217", "35.231.114.217"));
        vSeeds.push_back(CDNSSeedData("35.227.33.76", "35.227.33.76"));
	    vSeeds.push_back(CDNSSeedData("35.185.100.238", "35.185.100.238"));
