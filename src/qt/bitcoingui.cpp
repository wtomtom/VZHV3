                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("vizeh Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a vizeh address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vizeh: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About vizeh Core"), this);
    aboutAction->setStatusTip(tr("Show information about vizeh Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for vizeh"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your vizeh addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified vizeh addresses"));
    ...
    openAction->setStatusTip(tr("Open a vizeh: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the vizeh Core help message to get a list with possible vizeh command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("vizeh Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to vizeh network", "", count));
}
...
{
    QString strTitle = tr("vizeh Core"); // default title
